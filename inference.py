...
if __name__ == "__main__":
    ...
    # parser.add_argument("--fid_path", type=str, default="./save/SUMMARY_FiDT5_best_s27000_V2.pt")
    parser.add_argument("--fid_path", type=str, default="./SUMMARY_FiDT5_best_s27000_V2.pt")
    
    parser.add_argument("--question", type=str, default='장기 이식으로 인해 얻을 수 있는 효과는?')
