...
class Options():
    ...
    def add_optim_options(self):
        self.parser.add_argument('--warmup_steps', type=int, default=1000) # 0.05 * total_steps (then 약 1,000)
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--first_k', type=int, default=-1)
        self.parser.add_argument('--model_name', type=str, default='KETI-AIR/ke-t5-large')
        self.parser.add_argument('--kv_heads', type=int, default=-1)
        self.parser.add_argument('--n_cross_layer', type=int, default=-1)
        # self.parser.add_argument('--num_passages', type=int, default=10)
    ...
    def initialize_parser(self):
        ...
        # dataset parameters
        self.parser.add_argument("--per_gpu_batch_size", default=4, type=int, 
        ...
        # training parameters
        self.parser.add_argument('--eval_freq', type=int, default=1000, # SUMMARY: 1000, MRC: 3000
    ...
    def parse(self):
        opt = self.parser.parse_args([]) # Jupyter 실행 시 '[]' 활용
        return opt
