...
class EncoderDecoderModel(PreTrainedModel):
    ...
    def __init__(
        ...
        if decoder is None:
            ...
            decoder = GPT2LMHeadModel(config.decoder)
    ...
    def forward(
        ...
        **kwargs,
        ...
        if labels is not None:
            ...
            loss_fct = CrossEntropyLoss() # NOTE: cuda로 보내줌
    ...
    def prepare_inputs_for_generation(
        ...
        # NOTE: self.decoder => self.decoder.decoder ( DecoderWrapper로 인해 한 개가 추가로 쌓임! )
        decoder_inputs = self.decoder.decoder.prepare_inputs_for_generation(input_ids, past_key_values=past_key_values)
